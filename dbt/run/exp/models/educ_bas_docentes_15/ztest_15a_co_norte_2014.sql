  ...
  create  table "postgres"."dbt_staging"."ztest_15a_co_norte_2014__dbt_tmp"
  ...
  (
    ...
    (WITH FORMACAO_ADEQUADA_LICEN as (
        ...
        TB_CONTINUO as (
            SELECT
                "ANO", "ETAPA", "CO_MUNICIPIO", "TP_DEPENDENCIA", "DISCIPLINA_NOME",
    ...
    GROUP BY
        "ANO", "ETAPA", "CO_MUNICIPIO", "TP_DEPENDENCIA", "DISCIPLINA_NOME", "FORMACAO_COD", "FORMACAO_NOME"
    ORDER BY
        "CO_MUNICIPIO", "TP_DEPENDENCIA", "DISCIPLINA_NOME", "FORMACAO_ADEQUADA") as regi
