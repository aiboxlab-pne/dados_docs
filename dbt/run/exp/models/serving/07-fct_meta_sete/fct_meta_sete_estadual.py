...
def ref(*args, **kwargs):
    refs = {"dim_ideb_estadual": "\"postgres\".\"dbt_staging\".\"dim_ideb_estadual\"", "info_municipios": "\"postgres\".\"dbt_staging\".\"info_municipios\""}
    key = '.'.join(args)
...
def main(read_df, write_df, fal_context=None):
  ...
  return write_df(
      'postgres.dbt_serving.fct_meta_sete_estadual',
      df
  )